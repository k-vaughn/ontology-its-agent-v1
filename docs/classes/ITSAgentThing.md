...
Added for organizational purposes to identify classes defined in the Agent part of the ITS Ontology.
...
=== "SVG (interactive)"
    ...
    <text xml:space="preserve" text-anchor="start" x="7.25" y="-29.88" font-family="Arial" font-size="12.00">ITSAgentThing</text>
...
| Class | Description |
|-------|-------------|
| [Agent](Agent.md) | A person, organization, group, or software agent that performs a role. The role may add additional properties to the agent. |
| [Role](Role.md) | A role that an agent can perform. The role may add additional properties to the agent. |
